# Six projects, each with a demo you can run

A small site hosting interactive demos for six machine learning and data science
projects. Everything runs client-side, with nothing uploaded and no
server involved, but in two different ways.

**Three fit their models in the browser.** These use
